...
module Pandatone
  ...
  class GridTest < ActiveSupport::TestCase
    STYLESHEETS = Pandatone::Engine.root.glob("app/assets/stylesheets/pandatone/*.css").freeze
    ...
    private
      ...
      def theme = sheet("tokens")

      def type = sheet("type")

      def sheet(name)
        (@sheets ||= {})[name] ||= Pandatone::Engine.root.join("app/assets/stylesheets/pandatone/#{name}.css").read
      end
  end
end
